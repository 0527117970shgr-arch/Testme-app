            ...
            <div style={{
                ...
                <div style={{ flex: '1 1 250px' }}>
                    <div style={{ height: '150px', marginBottom: '1rem' }}>
                        <img src="https://images.unsplash.com/photo-1615906655593-ad0386982a0f?auto=format&fit=crop&w=400&q=80" alt="Pickup" style={{ width: '100%', height: '100%', objectFit: 'cover', borderRadius: '8px' }} />
                    </div>
